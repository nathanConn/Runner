...
class GearsControllerTest < ActionController::TestCase
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post :create, gear: { character_id: @gear.character_id, misc: @gear.misc, name: @gear.name, rating: @gear.rating, wireless: @gear.wireless }
    end
  ...
  test "should update gear" do
    patch :update, id: @gear, gear: { character_id: @gear.character_id, misc: @gear.misc, name: @gear.name, rating: @gear.rating, wireless: @gear.wireless }
    assert_redirected_to gear_path(assigns(:gear))
  end
