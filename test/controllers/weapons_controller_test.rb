...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { ammo: @weapon.ammo, character_id: @weapon.character_id, damage: @weapon.damage, misc: @weapon.misc, name: @weapon.name, wireless: @weapon.wireless }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { ammo: @weapon.ammo, character_id: @weapon.character_id, damage: @weapon.damage, misc: @weapon.misc, name: @weapon.name, wireless: @weapon.wireless }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
